    ...
    <>
      <nav className={`sticky top-0 z-50 w-full backdrop-blur-xl bg-black/30 border-b border-[#ff0a45]/25 shadow-[0_0_20px_rgba(255,0,80,0.35)] transition-all duration-300 ease-out ${className}`}>
        <div className="flex items-center justify-between h-16 px-6 md:px-8">
          ...
          <NavLink
            to="/"
            className="text-lg font-semibold text-white hover:text-[#ff0a45] transition-colors"
          >
            DealflowOS
          </NavLink>
                ...
                <NavLink
                  ...
                  className={`
                    ...
                    ${isActive 
                      ...
                      : 'text-white/70 hover:text-[#ff0a45]'
                    }
                  `}
                >
                  {item.label}
          ...
          <button
            ...
            className="md:hidden text-white/70 hover:text-[#ff0a45] transition-colors p-2"
                  ...
                  <NavLink
                    ...
                    className={`
                      ...
                      ${isActive
                        ...
                        : 'text-white/70 hover:text-[#ff0a45] hover:bg-white/5'
                      }
                    `}
                  >
                    {item.label}
