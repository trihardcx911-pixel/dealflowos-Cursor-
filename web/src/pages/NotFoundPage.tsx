...
export default function NotFoundPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      <Link to="/dashboard" className="mt-6 rounded-xl bg-[#ff0a45] px-6 py-3 text-sm font-semibold text-white hover:bg-[#ff0a45]/90 shadow-[0_0_10px_#ff0a45] transition-all">
        Back to dashboard
      </Link>
    </div>
  )
